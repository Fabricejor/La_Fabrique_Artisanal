        ...
        <div className="relative  w-64 p-4 ">
            ...
            <div className="absolute bottom-full left-1/2 transform -translate-x-1/2 mb-2 hidden group-hover:block">
              ...
              <div className="w-2 h-2 bg-black transform rotate-45 absolute -translate-y-1 top-full left-1/2 -translate-x-1/2"></div>
                ...
                <Link href={'#'}
                    className={`absolute bottom-0 left-0 right-0 bg-black text-white text-center py-2 transition-opacity duration-300 ${isHovered ? "opacity-100" : "opacity-0"
                        }`}
                >
                    READ MORE
                </Link>
            ...
            <div className="mt-2 text-left">
                ...
                <p className="text-[1rem] text-orange-400">{price} XOF FCFA</p>
            </div>
        </div>
    )
}
