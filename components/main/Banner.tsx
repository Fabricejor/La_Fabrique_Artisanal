...
export default function Banner() {
    return (
        <header className='w-full h-full mt-28 bg-white flex flex-row items-center gap-10 justify-between px-10'>
            ...
            <div className='BIGIMAG w-full flex flex-row justify-between'>
                <Image src="/banner.jpeg" width={100} height={100} className='w-[100%]' alt='banner image' />
